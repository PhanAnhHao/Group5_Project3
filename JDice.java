...
// Chưa khai báo resultList
	...
	private void doClear(){
	    ...
	    listItems.clear();
		// thiếu dấu chấm ; ở dòng 71
	    resultList.setListData(listItems);
	}

	// sai cú pháp privatevoid không phải là loại hợp lệ trong Java dòng 77
	private void doRoll(String name,
	    ...
	    if(name!=null) {
// Thiếu dấu chấm ở giữa listItems và add
	...
	// thừa dấu : sau void main dòng 109
    public static void main(String[] args) {
	Vector<String> v=new Vector<String>(); //BufferedReader brkhông được đóng đúng cách.
	if(args.length>=1) {
	    try (
